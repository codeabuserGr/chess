    ...
    try {
        ...
        while (file >> turn >> white_move >> black_move) {
            ...
            if (white_move[0] >= 'a' && white_move[0] <= 'h' && (
                ...
                //promotion
                if (white_move[1] == 'x' && (white_move[2] >= 'a' && white_move[2] <= 'h') && (
                        white_move[3] - '0' >= 1 && white_move[1] - '0' <= 8))
                    move(
                        stoll(m), '\0', white_move[3], white_move[4] - '0', true, white_move[0], 0, white_move[5]);
                else if ((white_move[1] - '0' >= 1 && white_move[1] - '0' <= 8)) {
                ...
                if (white_move[1] >= 'a' && white_move[1] <= 'h' && (
                    ...
                    if (white_move[2] == 'x' && (white_move[3] >= 'a' && white_move[3] <= 'h') && (
                        ...
                        move(
                            stoll(m), white_move[0], white_move[3], white_move[4] - '0', true, white_move[1], 0, '\0');
                    else if (white_move[2] >= 'a' && white_move[2] <= 'h')
                        move(
                            stoll(m), white_move[0], white_move[2], white_move[3] - '0', true, white_move[1], 0, '\0');
                } else if (white_move[1] - '0' >= 1 && white_move[1] - '0' <= 8) {
                    //piece ambiguous rank
                    if (white_move[2] == 'x' && (white_move[3] >= 'a' && white_move[3] <= 'h') && (
                            white_move[4] - '0' >= 1 && white_move[4] - '0' <= 8))
                        move(
                            stoll(m), white_move[0], white_move[3], white_move[4] - '0', true, '\0', white_move[1],
                            '\0');
                    else if (white_move[2] >= 'a' && white_move[2] <= 'h')
                        move(
                            stoll(m), white_move[0], white_move[2], white_move[3] - '0', true, '\0', white_move[1],
                            '\0');
            ...
            } else if (white_move == "O-O") { move(stoll(m), 'C', 'g', 1, true, '\0', 0, '\0'); } else if (
                white_move == "O-O-O")
            ...
            for (int j=0; j<16; j++) {
                ...
                for (int z=0; z<64; z++){
                    ...
                    if (BlackPieces[j]->get_legal_moves()[z]==true){l=true; break;}
                }
            }
            if (!l && WhitePieces[12]->checked){cout<<"Checkmate. 0-1"; return 0;}
            if (!l){cout << "Stalemate. 0.5-0.5"; return 0;}
            if (black_move[0] >= 'a' && black_move[0] <= 'h' && (
                ...
                //promotion
                if (black_move[1] == 'x' && (black_move[2] >= 'a' && black_move[2] <= 'h') && (
                        black_move[3] - '0' >= 1 && black_move[1] - '0' <= 8))
                    move(stoll(m), '\0', black_move[3], black_move[4] - '0', false, black_move[0], 0, black_move[5]);
                else if ((black_move[1] - '0' >= 1 && black_move[1] - '0' <= 8)) {
                ...
                if (black_move[1] >= 'a' && black_move[1] <= 'h' && (
                    ...
                    if (black_move[2] == 'x' && (black_move[3] >= 'a' && black_move[3] <= 'h') && (
                            black_move[4] - '0' >= 1 && black_move[4] - '0' <= 8))
                        move(stoll(m), black_move[0], black_move[3], black_move[4] - '0', false, '\0', black_move[1],
                             '\0');
                    else if (black_move[2] >= 'a' && black_move[2] <= 'h')
                        move(stoll(m), black_move[0], black_move[2], black_move[3] - '0', false, '\0', black_move[1],
                             '\0');
            ...
            for (int j=0; j<16; j++) {
                ...
                for (int z=0; z<64; z++){
                    ...
                    if (WhitePieces[j]->get_legal_moves()[z]==true){l=true; break;}
                }
            }
            if (!l && WhitePieces[12]->checked){cout<<"Checkmate. 0-1"; return 0;}
            if (!l){cout << "Stalemate. 0.5-0.5"; return 0;}
